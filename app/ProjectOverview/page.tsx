        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
          ...
          <div style={{ marginBottom: "3rem" }}>
            ...
            >
              ...
              data to estimate risk early. Through this, we help reduce save
              money by avoiding expensive repairs, and keep systems running
              smoothly.
            </p>
          </div>
          ...
          >
            <div
              style={{
                ...
                backgroundColor: "var(--status-box-bg)",
                padding: "1.5rem",
                boxShadow:
                  "0 2px 4px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.08)",
              }}
            >
              <h3
                style={{
            ...
            >
              ...
              >
                Instead of raw sensor graphs, we summarize motor condition into
                a simple health score and trend that's easy to read fast.
              </p>
            </div>
          </div>
...
function SimulinkIcon() {
  return (
    ...
    >
      ...
      <circle cx="30" cy="30" r="4" fill="var(--card-bg)" />
      {/* Data waves */}
      <path
...
function SensorIcon() {
  return (
    ...
    >
      ...
      {/* Chip representation */}
      <rect x="24" y="30" width="12" height="8" fill="var(--card-bg)" />
      <line
        x1="27"
        y1="32"
        x2="33"
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        opacity="0.2"
      />
      <rect x="10" y="14" width="40" height="32" rx="1" fill="var(--card-bg)" />
      {/* Graph bars */}
    ...
    >
      ...
      <div style={{ flex: "0 0 auto", margin: "0 0.5rem" }}>
        <svg width="40" height="20" viewBox="0 0 40 20" fill="none">
          <path
            d="M5 10 L35 10 M30 6 L35 10 L30 14"
            stroke="#6299BB"
            strokeWidth="2.5"
            fill="none"
          />
