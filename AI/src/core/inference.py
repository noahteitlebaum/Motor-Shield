...
class MotorFaultPredictor:
    ...
    def __init__(self, model_path: str = '../../artifacts/improved/motor_fault_model.pth', 
                 metadata_path: str = '../../artifacts/improved/model_metadata.pkl',
...
def main():
    ...
    if args.csv:
        ...
        print(f"Example: python src/core/inference.py --csv ../../files/Healthy/BLDC_Healthy_0.1Nm.csv")
