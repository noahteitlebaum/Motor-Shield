...
export default function StatusSection({
  ...
  return (
    <Card
      className={`w-full min-h-[400px] mb-5 p-6 transition-colors duration-500 bg-default-50 border-none`}
    >
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <Chip className="mb-1" color="success" size="sm" variant="flat">
                LIVE
              </Chip>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-auto">
            <div className="p-4 bg-background rounded-xl border border-default-200 flex flex-col items-center">
              ...
              <p
                className={`text-2xl font-mono font-bold text-center mt-1 ${isHealthy ? "text-success" : "text-danger"}`}
              >
