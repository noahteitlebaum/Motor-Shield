...
export default function MotorStatus({ diagnosis = "Healthy" }: { diagnosis?: string }) {
  ...
  return (
    <Card className="h-full min-h-[250px] transition-colors duration-500 border-none bg-background">
      <CardBody className="p-6 flex flex-col items-center justify-center">
        <h3 className="font-bold text-center mb-6 text-lg tracking-wide uppercase">AI Diagnostic Score</h3>
